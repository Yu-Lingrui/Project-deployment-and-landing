...
if __name__ == '__main__':
    ...
    #img = torch.zeros(opt.batch_size, 3, *opt.img_size).to(device, dtype=torch.float16)  # image size(1,3,320,192) iDetection
    ####################################################################################
    ...
    for k, m in model.named_modules():
        ...
        # elif isinstance(m, models.yolo_Ncla.IKeypoint):
