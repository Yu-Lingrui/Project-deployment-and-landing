...
**说明**：利用*python*完成模型训练(分布式)，推理测试，调优，轻量化等；利用*python & c++* 完成模型转换，加速等；利用*python & c++* 模型项目部署测试(精度(INT_8,混合)，速度fps，线程，内存(稳定，泄露)等)；利用*python_flask & js，html* 完成前端开发在本地或云服务器上实现最终落地。
